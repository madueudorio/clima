...
function App(): React.JSX.Element {
  ...
  const [rainProbabillity, setRainProbabillity] = useState<string>("30");
  ...
  return (
    <View style={[styles.container, night == false ? styles.containerBgDay : styles.containerBgNight]}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <Image source={require('./src/assets/images/icon3.png')}></Image>

      </View>
      <View>
        <Text style={styles.weatherCondition}>{condition}</Text>
        <Text style={styles.text}>Sensação Térmica:{feelsLike} °C</Text>
        <Text style={styles.text}>Probalidade de Chuva:{rainProbabillity}%</Text>
